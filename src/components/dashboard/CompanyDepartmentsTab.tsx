...
export default function CompanyDepartmentsTab() {
  ...
  return (
    <div className="max-w-5xl">
      {canManage && (
        <form onSubmit={handleAddDepartment} className="dark:bg-zinc-900 bg-white border dark:border-white/[0.06] border-gray-200 rounded-2xl p-6 mb-8 flex flex-col sm:flex-row items-end gap-6 shadow-sm">
          <div className="flex-1 w-full">
            ...
            <input
              ...
              className="w-full dark:bg-zinc-900/80 bg-gray-50 border dark:border-white/[0.08] border-gray-200 rounded-2xl px-4 py-3 text-sm dark:text-zinc-100 text-gray-900 placeholder-zinc-500 focus:outline-none focus:border-emerald-500/50 focus:ring-1 focus:ring-emerald-500/20 transition-all"
          ...
          <button
            ...
            className="w-full sm:w-auto bg-emerald-500 hover:bg-emerald-400 disabled:dark:bg-zinc-800 bg-gray-200 disabled:dark:text-zinc-500 text-gray-500 text-black px-8 py-3 rounded-2xl font-bold uppercase tracking-wide transition-all text-sm flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(16,185,129,0.25)] active:scale-[0.98]"
          >
      ...
      <div className="dark:bg-zinc-900 bg-white border dark:border-white/[0.06] border-gray-200 rounded-2xl overflow-hidden shadow-sm">
        {departments.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead className="sticky top-0 z-10 dark:bg-zinc-800 bg-gray-50/80 backdrop-blur-md">
                <tr className="border-b dark:border-white/[0.06] border-gray-200">
              ...
              <tbody className="text-sm dark:text-zinc-300 text-gray-700">
                {departments.map((dept) => (
                  <tr key={dept._id} className="group border-b dark:border-white/[0.06] border-gray-200 dark:hover:bg-white/[0.03] hover:bg-emerald-50/50 transition-colors">
                    ...
                    {canManage && (
                      <td className="px-6 py-4.5 text-right">
                        <button
                          ...
                          className="text-red-400 hover:text-red-300 transition-colors p-2 rounded-2xl hover:bg-red-500/10 inline-flex items-center opacity-70 hover:opacity-100"
