...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex-1 dark:bg-[#050505] bg-gray-50 pt-24 pb-12 px-4 min-h-screen">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="pt-6">
          <button
            ...
            className="w-full bg-emerald-500 hover:bg-emerald-400 text-black font-bold uppercase tracking-wide py-4 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.15)] hover:shadow-[0_0_30px_rgba(16,185,129,0.25)] active:scale-[0.98]"
          >
